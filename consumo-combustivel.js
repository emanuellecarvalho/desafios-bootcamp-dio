...
Assim, você conseguirá passar para Rubens qual a distância percorrida e, em seguida, calcular quantos litros serão necessários
...
let line = gets().split(" ");
let tempoGasto = parseInt(line[0]);
let velocidadeMedia = parseInt(line[1]);

let media =  (tempoGasto * velocidadeMedia)  / 12;
